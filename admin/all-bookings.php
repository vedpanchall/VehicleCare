...
<html>
<head>
<title>SVHMS | All Bookings</title>
                        ...
                        <table id="table">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT 
                                            ...
                                            appointment.pickup_drop_address,
                                            appointment.city AS appointment_city,
                                            appointment.area,
                                            user.First_name,
                                            user.Last_name,
                                            user.email,
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($result->appointment_city);?><br />
                                        <?php echo htmlentities($result->pickup_drop_address);?></td>
                                    <td><?php echo htmlentities($result->preferred_datetime);?></td>
                                    <td><?php echo htmlentities($result->postingDate);?></td>
                                    <td><a href="booking-details.php?bid=<?php echo htmlentities($result->id);?>&&bookingid=<?php echo htmlentities($result->id);?>">View</a></td>
                                </tr>
                                <?php } 
                                } else { ?>
                                <tr>
