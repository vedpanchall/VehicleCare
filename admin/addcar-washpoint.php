...
<html>
<head>
<title>SVHMS | Add Service Centers</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Add Service Centers </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<!---->
  <div class="grid-form1">
  	       <h3>Add Service Centers</h3>

  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="washingpoint" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Add Service Centers Name</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="washingpointname" id="washingpointname" placeholder="Add Service Centers Name" required>
									</div>
								</div>
<div class="form-group">
